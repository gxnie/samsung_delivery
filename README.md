...
* 박용재 : 쉽지않은 프로젝트였고 전부 구현하진 못했으나 좋은 조원분들과 함께해서 즐거운 마음으로 할 수 있었습니다.
  이번 경험으로 많이 배웠고 부족한 부분을 많이 느껴서 앞으로 더욱 노력할 수 있도록 하겠습니다.
  모두 고생많으셨습니다. 감사합니다.

* 하진이 : 이번 팀 프로젝트를 통해 정말 많은 것을 배우고 성장할 수 있었습니다.  팀원분들이 많이 도와주시고 알려주신 덕분에 무사히 해낼 수 있었습니다. 아직 부족하지만 Git 관리(Pull Request나 Pull 등)나 CRUD 같은 기술적인 부분도 더 잘 이해하게 되었고, 프로젝트 설계 과정과 협업의 중요성도 몸소 느낄 수 있던 시간이었습니다.
특히, 팀원분들의 적극적인 참여와 활발한 소통 덕분에 프로젝트가 점점 더 좋은 방향으로 나아갈 수 있었던 것 같습니다! 함께 이야기를 나누고 의견을 조율하면서 소통이 얼마나 중요한지 다시 한번 깨달을 수 있었고, 코드 컨벤션이나 Git 규칙, 이슈와 PR 관리 같은 부분들이 프로젝트 진행을 훨씬 효율적으로 만들어준다는 것도 알게 되었습니다!
그리고 주말에 개인 사정으로 함께하지 못했던 부분은 매우매우 아쉬움과 죄송함으로 남지만, 이번 경험을 통해 얻은 배움을 바탕으로 앞으로 더 노력하고 발전하고 싶습니다! 함께 해주신 팀원들께 정말 감사드리며, 모두 고생 많으셨고, 감사합니다! 😊
